angular.module('umbraco').controller('tea.textstring-with-counter.controller', function ($scope, $http, $routeParams, assetsService, notificationsService) {

  assetsService.loadCss('/App_Plugins/teasolutions/property-editors/textstring-with-counter/styles.css');
